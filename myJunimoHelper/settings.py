"""
Django settings for myJunimoHelper project.
...
ROOT_URLCONF = 'myJunimoHelper.urls'
...
WSGI_APPLICATION = 'myJunimoHelper.wsgi.application'
...
AUTH_USER_MODEL = 'JunimoDatabaseApp.User'
